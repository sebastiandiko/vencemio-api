...
const notificationRoute = require('./routes/notificationRoute'); // Ruta para notificaciones
...
app.use('/api/notificaciones', notificationRoute); // Asegúrate de que esta línea esté presente
